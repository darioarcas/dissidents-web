    ...
    <footer className='footer z-3 position-absolute w-100 opacity-50'>
        <nav className='navegacion-footer'>
            ...
            <ul>
                <li> 
                    {/* YOUTUBE */}
                    <a href="https://www.youtube.com/@DissidentsRecords" target="_blank" rel="noopener noreferrer">
                ...
                <li>
                    {/* BEATPORT */}
                    <a href="https://www.beatport.com/es/label/dissidents/120479" target="_blank" rel="noopener noreferrer">
